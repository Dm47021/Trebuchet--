...
import com.osiris.trebuchet.DropTarget.DragObject;
import com.osiris.trebuchet.preference.*;
...
public final class Launcher extends Activity
    ...
    static final String INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION =
            "com.osiris.trebuchet.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION";
    ...
    protected void onActivityResult(
        ...
        if (resultCode == RESULT_OK && mPendingAddInfo.container != com.osiris.trebuchet.ItemInfo.NO_ID) {
    ...
    private void restoreState(Bundle savedState) {
        ...
        if (pendingAddContainer != com.osiris.trebuchet.ItemInfo.NO_ID && pendingAddScreen > -1) {
    ...
    void completeAddApplication(Intent data, long container, int screen, int cellX, int cellY) {
        ...
        if (info != null) {
            ...
            info.container = com.osiris.trebuchet.ItemInfo.NO_ID;
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_SCREEN_OFF.equals(action)) {
                ...
                if (mAppsCustomizeTabHost != null && mPendingAddInfo.container == com.osiris.trebuchet.ItemInfo.NO_ID) {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        if (mPendingAddInfo.container != com.osiris.trebuchet.ItemInfo.NO_ID && mPendingAddInfo.screen > -1 &&
                mWaitingForResult) {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        // Hide preferences if not on osiris or not default launcher
        // (in which case preferences don't get shown in system settings)
        boolean preferencesVisible = !getPackageManager().hasSystemFeature("com.osiris.android") ||
    ...
    private void resetAddInfo() {
        mPendingAddInfo.container = com.osiris.trebuchet.ItemInfo.NO_ID;
